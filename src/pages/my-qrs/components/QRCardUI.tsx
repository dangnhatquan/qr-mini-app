...
export const QRCardUI: React.FC<QRCardUIProps> = ({ qr, showMore = true, onMoreClick }) => {
  ...
  return (
    <Box
      className={`rounded-3xl p-7 w-full h-[250px] flex flex-col justify-between relative overflow-hidden text-white border border-white/10 shadow-2xl ${getBgColor()}`}
    >
